...
def eval(network_file_path):
    ...
    community_file_path = network_file_path + '/gemsec-regu.dat'
    ground_truth_file_path = network_file_path + '/community.dat'
...
if __name__ == "__main__":
    ...
    for folder in folders:
        args.networkFile = 'real-world dataset/{}'.format(folder)
