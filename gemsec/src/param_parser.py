...
def parameter_parser():
    ...
    parser.add_argument("--input",
                        nargs="?",
                        default="/home2/s20235025/bigdata/GEMSEC/data/tmp.csv",
	                help="Input graph path.")

    parser.add_argument("--embedding-output",
                        nargs="?",
                        default="./output/embeddings/tmp_GEMSEC.csv",
	                help="Embeddings path.") # company_edges

    parser.add_argument("--cluster-mean-output",
                        nargs="?",
                        default="./output/cluster_means/tmp.csv",
	                help="Cluster means path.")

    parser.add_argument("--log-output",
                        nargs="?",
                        default="./output/logs/tmp.json",
	                help="Log path.")

    parser.add_argument("--assignment-output",
                        nargs="?",
                        default="./output/assignments/tmp.json",
	                help="Log path.")
